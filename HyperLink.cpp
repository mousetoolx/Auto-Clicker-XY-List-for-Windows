...
COLORREF CHyperLink::g_crLinkColor		= RGB(0x33, 0x99, 0x00);	// Default: Blue
COLORREF CHyperLink::g_crActiveColor    = RGB(0x33, 0x99, 0x00);	// Default: Dark cyan
COLORREF CHyperLink::g_crVisitedColor   = RGB(0x33, 0x99, 0x00);	// Default: Purple
COLORREF CHyperLink::g_crHoverColor     = RGB(0x66, 0xCC, 0x00);	// Default: Red
